...
dist/malloc.wasm: lib/memcpy.wasm lib/memset.wasm lib/err.wasm lib/sbrk.wasm lib/stdlib.wasm
	...
	$(WABT_BIN)/wast2wasm lib/malloc.wast -o lib/malloc.wasm
	$(WABT_BIN)/wasm-link lib/malloc.wasm lib/memcpy.wasm lib/memset.wasm lib/err.wasm lib/sbrk.wasm lib/stdlib.wasm -o dist/malloc.wasm
...
lib/memcpy.wasm:
	...
	$(WABT_BIN)/wast2wasm lib/memcpy.wast -o lib/memcpy.wasm
...
lib/memset.wasm:
	...
	$(WABT_BIN)/wast2wasm lib/memset.wast -o lib/memset.wasm

lib/stdlib-base.wasm:
	$(WABT_BIN)/wast2wasm src/stdlib-base.wast -o lib/stdlib.wasm
